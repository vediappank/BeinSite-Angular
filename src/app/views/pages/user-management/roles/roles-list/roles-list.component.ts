...
export class RolesListComponent implements OnInit, OnDestroy {
	...
	// displayedColumns = ['select', 'id', 'RoleName', 'RoleShortName','TeamMeetingApprover','OnetoOneMeetingApprover','TrainingMeetingApprover','ForecastApprover','ActionTrackerApprover', 'actions'];
	...
	addRole() {
		...
		this.editRole(newRole.id)
		//this.router.navigate(['../roles/add', 0], { relativeTo: this.activatedRoute });
	}
