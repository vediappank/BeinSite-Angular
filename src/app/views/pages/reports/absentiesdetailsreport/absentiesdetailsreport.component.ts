...
import { AgentAbsentiesDetailsRequest } from '../_models/agentabsentiesdetailsrequest.model'
...
@Component({
  selector: 'kt-absentiesdetailsreport',
  templateUrl: './absentiesdetailsreport.component.html',
  styleUrls: ['./absentiesdetailsreport.component.scss']
})
export class AbsentiesdetailsreportComponent implements OnInit {


  public reportType: string = 'agent';
  public reportRange: any;
  public reportFields: any;
  public agentreportinputReq: AgentAbsentiesDetailsRequest;
  public title = 'Agent Absense Details Report';
  private gridApi;
  ...
  refreshCols() {
    this.columnDefs = [  
      { headerName: 'Agent Id', field: 'AgentId', width: 150 },
      { headerName: 'Agent Name', field: 'AgentName', width: 200 },
      { headerName: 'First Name', field: 'FirstName', width: 275 },
      { headerName: 'Last Name', field: 'LastName', width: 275 } ,

      { headerName: 'Shift Start Time', field: 'ShiftStartTime', width: 200 },
      { headerName: 'Shift End Time', field: 'ShiftEndTime', width: 200 },
      { headerName: 'Shift Duration', field: 'ShiftDuration', width: 200 },
      { headerName: 'Login Counts', field: 'LoginCounts', width: 200 },
      { headerName: 'Actual Login Duration', field: 'ActualLoginDuration', width: 250 } ,
      { headerName: 'Actual Login Percentage', field: 'ActualLoginPercentage', width: 250 }  ,
      { headerName: 'Absence Duration', field: 'AbsenceDuration', width: 200 },
      { headerName: 'Absence Percentage', field: 'AbsencePercentage', width: 200 },
      { headerName: 'Late Duration', field: 'LateDuration', width: 200 },
      { headerName: 'Late Percentage', field: 'LatePercentage', width: 200 },
      { headerName: 'Left Early Duration', field: 'LeftEarlyDuration', width: 200 } ,
      { headerName: 'Left Early Percentage', field: 'LeftEarlyPercentage', width: 200 }  ,  

      { headerName: 'Is Late', field: 'IsLate', width: 150 },
      { headerName: 'Is Absent', field: 'IsAbsent', width: 150 } ,
      { headerName: 'Is PaidLeave', field: 'IsPaidLeave', width: 150 }  ,
      { headerName: 'Leave Name', field: 'LeaveName', width: 150 },
     
      { headerName: 'Is Left Early', field: 'IsLeftEarly', width: 150 }    
      ];
  ...
  getReportData() {
    ...
    if (this.reportRange.startDate && this.reportRange.endDate) {
      ...
      this.agentreportinputReq = {
        start_date_time: this.reportRange.startDate, end_date_time: this.reportRange.endDate, RoleID:this.RoleID,callcenter:''
      }
      ...
      //
      this.agentData = this.auth.GetAgentAbsentiesDetailsReport(this.agentreportinputReq);
