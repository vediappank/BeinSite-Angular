...
@Component({
  selector: 'kt-whatsupreport',
  templateUrl: './whatsupreport.component.html',
  styleUrls: ['./whatsupreport.component.scss']
})
export class WhatsupreportComponent implements OnInit {
  public reportType: string = 'agent';
  public reportRange: any;
  public reportFields: any;
  public agentreportinputReq: WhatsUpRequest;
  public title = 'WhatsApp Report';
  private gridApi;
  public elem;
...
public RoleID:number;
  ...
  refreshCols() {
    this.columnDefs = [      
      { headerName: 'Date', field: 'WhatsUpDate', width: 130 },
      { headerName: 'Assigned Count', field: 'AssignedCount', width: 130 },
      { headerName: 'Resolved Count', field: 'ResolvedCount', width: 130 },
      { headerName: 'Pending Count', field: 'PendingCount', width: 122 , cellStyle: params => params.value < 0? {'background-color': 'gray', color:'#fff'} : {color: 'black'}},
      { headerName: 'Resolved (%)', field: 'ResolvedPer', width: 122 },
      { headerName: 'Total Resolution (Sec)', field: 'TotalResolutionDuration', width: 200 },
      { headerName: 'Total Resolution (HH:MM:SS)', field: 'TotalResolutionTime', width: 200 },
      { headerName: 'Total Response (Sec)', field: 'TotalResponseDuration', width: 200 },
      { headerName: 'Total Response (HH:MM:SS)', field: 'TotalResponseTime', width: 200 },
      { headerName: 'Avg Resolution (Sec)', field: 'AvgResolutionDuration', width: 200 },
      { headerName: 'Avg Resolution (HH:MM:SS)', field: 'AvgResolutionTime', width: 200 },
      { headerName: 'Avg Response (Sec)', field: 'AvgResponseDuration', width: 200 },
      { headerName: 'Avg Response (HH:MM:SS)', field: 'AvgResponseTime', width: 200 }
    ];
  ...
  getReportData() {
    ...
    console.log('WhatsUp Data Function Called');
    if (this.reportRange.startDate && this.reportRange.endDate) {
      ...
      //
      this.agentData = this.auth.GetWhatsUpReport(this.agentreportinputReq);
      this.agentData.subscribe(_ratiobarList => {        
       // this.ShowBarCharts(_ratiobarList);  
        setTimeout(() => { this.autoSizeAll(); }, 1000);
        console.log('WhatsUp Response Called::::' + JSON.stringify(_ratiobarList));
      });
    }
  }
