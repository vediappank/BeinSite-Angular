...
@Component({
  selector: 'kt-bchart-two-dsstack-widget',
  templateUrl: './bchart-two-dsstack-widget.component.html',
  styleUrls: ['./bchart-two-dsstack-widget.component.scss']
})
export class BChartTwoDSStackWidgetComponent implements OnInit, OnChanges {
