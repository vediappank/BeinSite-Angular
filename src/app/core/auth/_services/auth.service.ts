...
export class AuthService {
    ...
    //    // const userToken = localStorage.getItem(localStorage.getItem('currentUser')).token);
    //     const httpHeaders = new HttpHeaders();
    //     httpHeaders.set('Authorization', 'Bearer ' + JSON.parse(localStorage.getItem('currentUser')).token);
