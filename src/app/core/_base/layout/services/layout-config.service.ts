...
export class LayoutConfigService {
  ...
  saveConfig(layoutConfig: LayoutConfigModel): void {
    if (layoutConfig) {
      ...
      // console.log('LayoutConfigService::Layout COnfig Saved:::' + JSON.stringify(localStorage.getItem('layoutConfig')));
    }
  }
  ...
  loadConfigs(config: LayoutConfigModel) {
    ...
    // console.log('BaseComponent:LayoutConfig:configs::::' + JSON.stringify(this.layoutConfig));
    // console.log('Layout Config Demo: ' + objectPath.get(this.layoutConfig, 'demo') );
    // console.log('Layout Config New Demo: ' + config.demo );
    // console.log('Layout Config New Demo: ' + (!this.layoutConfig || objectPath.get(this.layoutConfig, 'demo') !== config.demo) );
